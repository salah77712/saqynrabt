...
>
<div className="mx-auto max-w-4xl bg-[#F8F9FB] border border-[#141F33]/10 rounded-2xl shadow-2xl p-6">
{!showPrefs ? (
<>
...
className="min-h-[44px] px-4 py-2.5 rounded-xl border border-[#141F33]/10 text-xs font-bold text-[#141F33] hover:bg-[#141F33]/5 transition-all"
>
...
className="min-h-[44px] px-6 py-2.5 rounded-xl bg-[#141F33] text-[#F8F9FB] text-xs font-bold hover:bg-[#141F33]/90 transition-all"
>
...
<label className="flex items-center gap-3 p-3 rounded-xl border border-[#141F33]/10 bg-[#F8F9FB]">
...
<label className="flex items-center gap-3 p-3 rounded-xl border border-[#141F33]/10">
