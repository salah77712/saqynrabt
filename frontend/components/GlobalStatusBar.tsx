...
export function GlobalStatusBar() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`bg-white border border-gray-200 shadow-lg rounded-full flex items-center gap-2 transition-all duration-300 ${
        ...
        >
          ...
          {status === 'online' && (
            <span className="text-xs text-gray-500 whitespace-nowrap select-none">
