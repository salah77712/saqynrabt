...
<button
onClick={toggleTheme}
className="p-2 rounded-xl hover:bg-primary/5 dark:hover:bg-white/5 text-xs font-bold transition-all duration-300 min-h-[44px] min-w-[44px] border border-primary/10 dark:border-white/20 hover:border-accent/30 hover:shadow-sm"
title={isDark ? 'Switch to Light Mode' : 'Switch to Dark Mode'}
>
{isDark ? (
<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 256 256">
