...
<label className="flex flex-col items-center justify-center border-2 border-dashed border-[#141F33]/10 rounded-xl p-8 hover:bg-[#141F33]/5 cursor-pointer transition-all">
...
className="w-full bg-[#141F33] hover:bg-[#141F33]/90 disabled:opacity-40 text-white font-bold py-3 rounded-xl text-sm transition-all"
>
