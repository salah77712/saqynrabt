...
className={`px-3 py-2 rounded-[40px] text-xs font-bold min-h-[44px] transition-all duration-300 hover:shadow-md hover:scale-[1.02] active:scale-95 ${
...
<div className="p-4 bg-[#F8F9FB] rounded-[40px] text-center space-y-1">
