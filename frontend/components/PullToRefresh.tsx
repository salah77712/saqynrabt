    ...
    >
      {refreshing && (
        <div className="flex items-center justify-center py-4">
          <span className="h-6 w-6 rounded-full border-3 border-gray-200 border-t-[#141F33] animate-spin" />
          <span className="ml-2 text-xs font-bold text-[#718096]">Refreshing...</span>
        </div>
      )}
