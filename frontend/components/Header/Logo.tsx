...
export function Logo() {
  return (
    ...
    >
      <div className="flex h-10 w-10 items-center justify-center rounded-[40px] bg-[#141F33] dark:bg-[#141F33] text-sm font-bold text-[#F8F9FB] shadow-sm group-hover:scale-105 transition-transform">
        S
      </div>
