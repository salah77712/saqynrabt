...
<div className="bg-[#F8F9FB] border border-[#141F33]/10 rounded-xl max-w-sm w-full p-8 shadow-2xl space-y-6 relative" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
...
<p className="text-xs font-semibold text-[#141F33]/60 mt-3 leading-relaxed">{current.body}</p>
</div>

<div className="flex justify-between items-center pt-4 border-t border-[#141F33]/10">
<button
onClick={handleSkip}
className="text-[10px] font-bold text-[#141F33]/40 hover:text-[#141F33]"
>
