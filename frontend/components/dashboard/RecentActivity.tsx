...
import { PhoneIcon, ChatIcon, TeamIcon } from '../ui/Icons';
          ...
          >
            <div className="flex items-center gap-2">
              <span className="text-sm">
                {act.type === 'automation' ? <PhoneIcon className="w-4 h-4 text-slate-500" /> : act.type === 'chat' ? <ChatIcon className="w-4 h-4 text-slate-500" /> : <TeamIcon className="w-4 h-4 text-slate-500" />}
              </span>
