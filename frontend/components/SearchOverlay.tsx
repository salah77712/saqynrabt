...
>
<div className="w-full max-w-xl bg-surface dark:bg-primary rounded-xl shadow-2xl border border-primary/10 dark:border-surface/10 overflow-hidden animate-slideDown">
{/* Search Input */}
<div className="flex items-center gap-4 px-5 py-4 border-b border-primary/10 dark:border-surface/10">
<svg aria-hidden="true" className="h-5 w-5 text-primary/60 dark:text-surface/60 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
<p className="text-sm text-primary/60 dark:text-surface/60 font-medium">
{t('No results found for', 'لا توجد نتائج لـ')} &quot;{query}&quot;
</p>
<p className="text-xs text-primary/40 dark:text-surface/40 mt-2">
...
{items.map((item) => {
  ...
  idx === selectedIndex
  ? 'bg-primary text-primary dark:text-surface'
  : 'text-primary/70 dark:text-surface/70 hover:bg-primary dark:hover:bg-accent'
  }`}
  >
  <PageIcon />
  ...
  <p className="text-xs text-primary/60 dark:text-surface/60 truncate">{item.href}</p>
  </div>
  <svg aria-hidden="true"
  className="h-4 w-4 text-primary/40 dark:text-surface/40 flex-shrink-0 rtl:rotate-180"
  viewBox="0 0 20 20"
  fill="currentColor"
  >
  <path
...
className="rounded-full border border-primary/10 dark:border-surface/10 bg-surface dark:bg-primary px-3 py-1.5 text-xs font-semibold text-primary/60 dark:text-surface/60 hover:bg-primary dark:hover:bg-accent transition-colors min-h-[44px]"
>
{tag}
</button>
))}
...
<span className="flex items-center gap-1">
<kbd className="rounded border border-primary/10 dark:border-surface/10 bg-surface dark:bg-primary px-1.5 py-0.5">Enter</kbd>
{t('Open', 'افتح')}
</span>
</div>
...
function PageIcon() {
return (
<svg aria-hidden="true" className="h-4 w-4 text-primary/40 dark:text-surface/40 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
