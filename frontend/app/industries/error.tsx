    ...
    <div className="bg-white text-slate-900 min-h-screen flex flex-col font-sans">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-primary mb-2">Industries page unavailable</h1>
          <p className="text-slate-500 mb-8">We couldn&apos;t load the industries page. Please try again.</p>
