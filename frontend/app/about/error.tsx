  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-6 py-20 lg:px-8 w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-[#141F33] mb-2">{t({ en: 'About page unavailable', ar: 'صفحة حول غير متوفرة' })}</h1>
        <p className="text-[#141F33]/60 mb-2">{t({ en: "We couldn&apos;t load the about content.", ar: 'تعذر تحميل محتوى الصفحة.' })}</p>
        <p className="text-sm text-[#141F33]/40 mb-8">{t({ en: 'Please try again or return to the homepage.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
