  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-6 py-20 lg:px-8 w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-primary mb-2">About page unavailable</h1>
        <p className="text-slate-500 mb-2">We couldn&apos;t load the about content.</p>
        <p className="text-sm text-slate-400 mb-8">Please try again or return to the homepage.</p>
