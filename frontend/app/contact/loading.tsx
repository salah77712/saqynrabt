  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-6 py-20 lg:px-8 w-full">
        <div className="h-4 w-20 bg-[#141F33]/10 rounded animate-pulse mb-6" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="border border-[#141F33]/10 rounded-xl p-6">
              <div className="h-6 w-32 bg-[#141F33]/10 rounded animate-pulse mb-3" />
