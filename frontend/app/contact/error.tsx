  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-6 py-20 lg:px-8 w-full text-center">
        ...
        <p className="text-[#141F33] mb-2">{t({ en: "We couldn&apos;t load the contact form.", ar: 'تعذر تحميل نموذج الاتصال.' })}</p>
        <p className="text-sm text-[#141F33]/40 mb-8">{t({ en: 'Please email us directly at saqynrabt@gmail.com while we fix this.', ar: 'يرجى مراسلتنا على البريد الإلكتروني saqynrabt@gmail.com بينما نقوم بإصلاح هذا.' })}</p>
