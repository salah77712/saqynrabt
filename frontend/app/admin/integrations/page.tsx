      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-12 lg:px-8">
        ...
        <div className="bg-white rounded-[40px] border border-[#141F33]/10 p-8 shadow-[0_10px_40px_rgba(0,0,0,0.05)]">
          ...
          <div className="border-b border-[#141F33]/10 pb-6 mb-8">
            ...
            <p className="text-xs text-[#141F33]/60 font-semibold mt-2">
          ...
          <div className="mb-10">
            <h2 className="text-xs font-extrabold text-[#141F33] uppercase tracking-wider mb-4">Active Integrations</h2>
            <div className="space-y-4">
              {integrations.map((item, i) => (
                <div key={i} className="flex items-center justify-between p-4 bg-[#F8F9FB] border border-[#141F33]/5 rounded-[24px]">
                  <div>
                    <p className="text-sm font-bold text-[#141F33]">{item.name}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-[#141F33]/10">
            
            {/* Left Block: Merge Connection Link */}
            <div className="flex flex-col justify-between">
              <div>
                <h3 className="text-sm font-bold text-[#141F33]">Automated Unified API Sync</h3>
                <p className="text-xs text-[#141F33]/60 font-semibold mt-2 leading-relaxed">
              ...
              <div className="mt-6 flex items-center gap-4">
                ...
                <span className="text-[10px] text-[#141F33]/50 font-bold uppercase">Status: {syncStatus}</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative border-2 border-dashed border-[#141F33]/10 rounded-[40px] p-6 text-center hover:bg-[#F8F9FB] transition-colors">
                ...
                <p className="text-[10px] text-[#141F33]/40 mt-1 font-semibold">Only .csv files supported</p>
              </div>
