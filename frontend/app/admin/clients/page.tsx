...
className={`px-6 py-3 rounded-xl text-xs font-bold min-h-[44px] transition-all duration-300 hover:shadow-md hover:scale-[1.02] active:scale-95 ${c.status === 'active' ? 'bg-[#F8F9FB] text-[#141F33] border border-[#141F33]/10 hover:bg-[#141F33]/5' : 'bg-[#2A5CFF] text-[#F8F9FB] hover:bg-[#2A5CFF]/90'}`}
>
