  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-6 py-20 lg:px-8 w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-[#141F33] mb-2">{t({ en: 'Terms & conditions unavailable', ar: 'الشروط والأحكام غير متوفرة' })}</h1>
        <p className="text-[#141F33]/60 mb-2">{t({ en: "We couldn&apos;t load the terms and conditions.", ar: 'تعذر تحميل الشروط والأحكام.' })}</p>
        <p className="text-sm text-[#141F33]/40 mb-8">{t({ en: 'Please try again or contact us for a copy.', ar: 'يرجى المحاولة مرة أخرى أو الاتصال بنا للحصول على نسخة.' })}</p>
