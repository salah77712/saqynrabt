  ...
  return (
    <div className="bg-surface text-primary min-h-screen flex flex-col font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-28 text-center">
        <div className="mx-auto h-6 w-24 bg-surface rounded-full animate-pulse mb-6" />
      ...
      <section className="bg-surface py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[...Array(12)].map((_, i) => (
              <div key={i} className="bg-surface border border-primary/10 rounded-xl p-8">
                <div className="h-12 w-12 rounded-xl bg-surface animate-pulse mb-4" />
                <div className="h-5 w-40 bg-surface rounded animate-pulse mb-2" />
