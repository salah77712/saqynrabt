  ...
  return (
    <div className="bg-surface text-primary min-h-screen flex flex-col font-sans" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-12 lg:px-8">
        ...
        <div className="border-t-4 border-accent rounded-xl bg-background shadow-card p-8 lg:p-12 mb-12">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-background border border-primary/10 rounded-xl p-8 shadow-card flex flex-col justify-between">
              <div>
              ...
              <div>
                ...
                <div className="bg-surface rounded-xl border border-primary/10 p-3 mb-6 flex flex-col items-center justify-center min-h-[110px]">
                  <div className="flex items-center gap-3">
                    <div className="px-2 py-1 bg-background border border-primary/10 rounded-full text-[10px] font-bold text-primary">SAP</div>
                    
                    <svg aria-hidden="true" width="40" height="20" viewBox="0 0 40 20" fill="none" className="stroke-primary stroke-[1.5] text-primary">
                      <path d="M0,10 H40" strokeDasharray="3,3" />
                      <circle cx="20" cy="10" r="3" fill="currentColor" />
                    </svg>

                    <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-surface text-[10px] font-bold">RAG</div>
                    ...
                    <div className="px-2 py-1 bg-background border border-primary/10 rounded-full text-[10px] font-bold text-primary">Oracle</div>
                  </div>
                  <span className="text-[10px] font-bold text-primary/40 uppercase tracking-widest mt-3">Secure Read-Only Link</span>
                </div>

                <h3 className="text-base font-bold text-primary mb-3">SAP & Oracle Sync</h3>
                <p className="text-xs text-primary/60 font-semibold leading-relaxed">
        ...
        <section className="bg-background border border-primary/10 rounded-xl p-8 shadow-card mb-12">
