        ...
        <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full min-h-[44px] bg-slate-50 border border-gray-200 rounded-xl px-4 py-2 text-xs font-bold text-navy"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-slate-50 border border-gray-200 rounded-xl p-4 text-xs font-semibold text-navy focus:outline-none resize-none"
