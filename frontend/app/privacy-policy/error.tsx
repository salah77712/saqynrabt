  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-6 py-20 lg:px-8 w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-[#141F33] mb-2">{t({ en: 'Privacy policy unavailable', ar: 'سياسة الخصوصية غير متوفرة' })}</h1>
        <p className="text-[#141F33]/60 mb-2">{t({ en: "We couldn&apos;t load the privacy policy.", ar: 'تعذر تحميل سياسة الخصوصية.' })}</p>
