    ...
    <div className="bg-[#F8F9FB] text-[#141F33] min-h-screen flex flex-col font-sans">
      ...
      <section className="bg-[#F8F9FB] py-20">
        <div className="max-w-4xl mx-auto px-6 space-y-8">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="flex items-start gap-6 bg-[#F8F9FB] border border-[#141F33]/10 rounded-2xl p-6">
              <div className="h-14 w-14 shrink-0 rounded-2xl bg-[#F8F9FB] animate-pulse" />
