    ...
    <div className="bg-[#F8F9FB] text-[#141F33] min-h-screen flex flex-col font-sans">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-[#141F33] mb-2">{t({ en: 'How it works unavailable', ar: 'صفحة كيف يعمل غير متوفرة' })}</h1>
          <p className="text-[#141F33] mb-8">{t({ en: "We couldn&apos;t load this page. Please try again.", ar: 'تعذر تحميل هذه الصفحة. يرجى المحاولة مرة أخرى.' })}</p>
