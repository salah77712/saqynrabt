...
<div>
<h3 className="text-sm font-bold text-primary dark:text-surface">{t({en: 'Executive Audit PDF', ar: 'تقرير التدقيق التنفيذي PDF'})}</h3>
...
<Card className="flex flex-col justify-between p-8">
<div>
<h3 className="text-sm font-bold text-primary dark:text-surface">{t({en: 'Chat History CSV', ar: 'سجل المحادثات CSV'})}</h3>
<p className="text-xs text-primary mt-3 leading-relaxed">
...
<Card className="flex flex-col justify-between p-8">
<div>
<h3 className="text-sm font-bold text-primary dark:text-surface">{t({en: 'Usage Ledger Excel', ar: 'دفتر الاستخدام Excel'})}</h3>
<p className="text-xs text-primary mt-3 leading-relaxed">
