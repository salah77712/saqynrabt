  ...
  return (
    <div className="flex items-center justify-center py-20">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold text-[#141F33] mb-2">{t({ en: 'Settings didn\'t load', ar: 'صفحة الإعدادات غير متوفرة' })}</h2>
        <p className="text-[#141F33] mb-2">{t({ en: 'Your settings page had a hiccup.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
        <p className="text-sm text-[#141F33]/60 mb-8">{t({ en: 'Your preferences are saved. Try again to view them.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
