  ...
  return (
    <div className="flex items-center justify-center py-20">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold text-primary mb-2">{t({ en: 'Settings didn\'t load', ar: 'ØµÙØ­Ø© Ø§Ù„Ø¥Ø¹Ø¯Ø§Ø¯Ø§Øª ØºÙŠØ± Ù…ØªÙˆÙØ±Ø©' })}</h2>
        <p className="text-primary mb-2">{t({ en: 'Your settings page had a hiccup.', ar: 'ÙŠØ±Ø¬Ù‰ Ø§Ù„Ù…Ø­Ø§ÙˆÙ„Ø© Ù…Ø±Ø© Ø£Ø®Ø±Ù‰ Ø£Ùˆ Ø§Ù„Ø¹ÙˆØ¯Ø© Ø¥Ù„Ù‰ Ø§Ù„ØµÙØ­Ø© Ø§Ù„Ø±Ø¦ÙŠØ³ÙŠØ©.' })}</p>
        <p className="text-sm text-primary/60 mb-8">{t({ en: 'Your preferences are saved. Try again to view them.', ar: 'ÙŠØ±Ø¬Ù‰ Ø§Ù„Ù…Ø­Ø§ÙˆÙ„Ø© Ù…Ø±Ø© Ø£Ø®Ø±Ù‰ Ø£Ùˆ Ø§Ù„Ø¹ÙˆØ¯Ø© Ø¥Ù„Ù‰ Ø§Ù„ØµÙØ­Ø© Ø§Ù„Ø±Ø¦ÙŠØ³ÙŠØ©.' })}</p>
