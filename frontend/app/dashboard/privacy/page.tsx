...
<div className="w-10 h-10 rounded-xl bg-surface flex items-center justify-center shrink-0 text-accent">
<DownloadSvg />
</div>
...
{exportError && (
<p className="mt-3 text-xs text-primary">{exportError}</p>
)}
</div>
</div>
</Card>
...
<div className="flex items-start gap-8">
<div className="w-10 h-10 rounded-xl bg-surface flex items-center justify-center shrink-0 text-primary">
<TrashSvg />
</div>
<div className="flex-1">
<h2 className="text-sm font-bold text-primary">
...
{deletionConfirmed ? (
<div className="mt-3 flex items-start gap-3 text-accent text-xs bg-surface border border-primary/10 p-3 rounded-xl">
<AlertTriangleSvg />
<div>
...
<label className="flex items-center gap-3 text-xs text-primary">
<input
type="checkbox"
...
{deletionError && (
<p className="mt-3 text-xs text-primary">{deletionError}</p>
)}
</div>
</div>
</Card>

<div className="text-xs text-primary border-t border-primary/10 pt-4">
<p>
{t({
