...
<div className="w-10 h-10 rounded-[40px] bg-[#F8F9FB] flex items-center justify-center shrink-0 text-[#2A5CFF]">
<DownloadSvg />
</div>
...
{exportDone ? (
<div className="mt-3 flex items-center gap-3 text-[#2A5CFF] text-xs">
<CheckCircleSvg />
...
<Button
variant="default"
className="mt-3 py-3 px-6 rounded-[40px] text-xs font-bold min-h-[44px]"
...
{exportError && (
<p className="mt-3 text-xs text-[#141F33]">{exportError}</p>
)}
</div>
</div>
</Card>

<Card className="p-8 border-[#141F33]/10">
<div className="flex items-start gap-8">
<div className="w-10 h-10 rounded-[40px] bg-[#F8F9FB] flex items-center justify-center shrink-0 text-[#141F33]">
<TrashSvg />
</div>
<div className="flex-1">
<h2 className="text-sm font-bold text-[#141F33]">
...
{deletionConfirmed ? (
<div className="mt-3 flex items-start gap-3 text-[#2A5CFF] text-xs bg-[#F8F9FB] border border-[#141F33]/10 p-3 rounded-[40px]">
<AlertTriangleSvg />
<div>
...
<label className="flex items-center gap-3 text-xs text-[#141F33]">
<input
type="checkbox"
...
<Button
variant="destructive"
className="py-3 px-6 rounded-[40px] text-xs font-bold min-h-[44px]"
...
<Button variant="outline" className="py-3 px-6 rounded-[40px] text-xs font-bold min-h-[44px]" onClick={() => setDeletionRequested(false)}>
...
<Button
variant="outline"
          className="mt-3 py-3 px-6 rounded-[40px] text-xs font-bold min-h-[44px] border-[#141F33]/10 text-[#141F33] hover:bg-[#141F33]"
...
{deletionError && (
<p className="mt-3 text-xs text-[#141F33]">{deletionError}</p>
)}
</div>
</div>
</Card>

<div className="text-xs text-[#141F33] border-t border-[#141F33]/10 pt-4">
<p>
{t({
