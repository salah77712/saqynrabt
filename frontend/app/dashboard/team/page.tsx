...
<div key={m.id} className="bg-[#F8F9FB] border border-[#141F33]/10 rounded-xl p-8 shadow-sm">
...
<h3 className="text-xs md:text-sm font-black uppercase tracking-wider text-[#2A5CFF]">
...
<div className="space-y-3">
<h3 className="text-xs md:text-sm font-black uppercase tracking-wider text-navy dark:text-[#F8F9FB]">
