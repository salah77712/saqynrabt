...
function CheckCircleSvg() { return <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#16a34a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>; }
      ...
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="space-y-4">
          {status?.tos.needsAccept && (
            <label className="flex items-start gap-3 p-4 rounded-xl border border-gray-200 hover:border-[#141F33]/30 cursor-pointer transition-colors">
              <input
                type="checkbox"
                checked={tosChecked}
        ...
        {error && (
          <div className="mt-4 flex items-start gap-2 text-red-700 text-xs bg-red-50 p-3 rounded-xl">
            <AlertTriangleSvg />
            <p>{error}</p>
          </div>
        )}
