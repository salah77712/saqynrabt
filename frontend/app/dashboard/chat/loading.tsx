...
<div className="flex-1 rounded-xl border border-[#141F33]/10 bg-[#F8F9FB] p-8 shadow-sm">
...
<div className={`rounded-xl p-4 ${i % 2 === 0 ? 'bg-primary/10' : 'bg-[#F8F9FB]'}`}
...
<div className="h-14 rounded-xl border border-[#141F33]/10 bg-[#F8F9FB] shadow-sm">
<div className="h-full w-full bg-[#F8F9FB] rounded-xl animate-pulse" />
</div>
</div>
);
}