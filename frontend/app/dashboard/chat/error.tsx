...
<p className="text-[#141F33] mb-2">{t({ en: 'We hit a snag loading the knowledge hub.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
<p className="text-sm text-[#141F33] mb-8">{t({ en: 'Your conversations are all still there. Just give it another go.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
