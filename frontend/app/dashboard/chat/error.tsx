...
<h2 className="text-2xl font-bold text-primary mb-2">{t({ en: 'Chat couldn\'t load', ar: 'صفحة المحادثة غير متوفرة' })}</h2>
<p className="text-primary mb-2">{t({ en: 'We hit a snag loading the knowledge hub.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
<p className="text-sm text-primary mb-8">{t({ en: 'Your conversations are all still there. Just give it another go.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
