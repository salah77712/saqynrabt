  ...
  return (
    <div className="flex items-center justify-center py-20">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold text-primary mb-2">Chat unavailable</h2>
        <p className="text-slate-500 mb-2">We couldn&apos;t load the knowledge hub chat.</p>
        <p className="text-sm text-slate-400 mb-8">Your conversation history is safe. Please try again.</p>
