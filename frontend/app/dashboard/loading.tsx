export default function DashboardLoading() {
  return (
    <div className="space-y-6">
      <section className="rounded-xl border border-[#141F33]/10 r   p-8">
...
<div className="rounded-xl border border-[#141F33]/10 bg-[#141F33] px-5 py-4 backdrop-blur">
...
<div className="h-3 w-40 bg-[#141F33] rounded animate-pulse" />
          ...
          <div className="space-y-3">
            {[...Array(3)].map((_, i) => (
<div key={i} className="flex items-center gap-4 rounded-xl bg-[#141F33] px-4 py-3">
...
<div className="space-y-3">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="h-12 w-full rounded-xl bg-[#141F33] animate-pulse" />
            ))}
          </div>
        </div>
      </section>
