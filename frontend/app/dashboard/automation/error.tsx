...
<p className="text-primary mb-2">{t({ en: 'We had trouble fetching the guest queue.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
<p className="text-sm text-primary mb-8">{t({ en: 'New requests are still being accepted. Hit try again to refresh.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
