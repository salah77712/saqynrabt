  ...
  return (
    <div className="flex items-center justify-center py-20">
      <div className="text-center max-w-md">
        ...
        <p className="text-slate-500 mb-2">We had trouble fetching the guest queue.</p>
        <p className="text-sm text-slate-400 mb-8">New requests are still being accepted. Hit try again to refresh.</p>
