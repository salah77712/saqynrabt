...
<p className="text-[#141F33] mb-2">{t({ en: 'Your document library had trouble loading.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
<p className="text-sm text-[#141F33] mb-8">{t({ en: 'Your files are safe. Tap try again when you\'re ready.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
