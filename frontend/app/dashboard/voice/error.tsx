...
<h2 className="text-2xl font-bold text-primary mb-2">{t({ en: 'Voice hub offline', ar: 'Ù…Ø±ÙƒØ² Ø§Ù„ØµÙˆØª ØºÙŠØ± Ù…ØªØµÙ„' })}</h2>
<p className="text-primary mb-2">{t({ en: 'The voice dispatch dashboard had a hiccup.', ar: 'ÙŠØ±Ø¬Ù‰ Ø§Ù„Ù…Ø­Ø§ÙˆÙ„Ø© Ù…Ø±Ø© Ø£Ø®Ø±Ù‰ Ø£Ùˆ Ø§Ù„Ø¹ÙˆØ¯Ø© Ø¥Ù„Ù‰ Ø§Ù„ØµÙØ­Ø© Ø§Ù„Ø±Ø¦ÙŠØ³ÙŠØ©.' })}</p>
<p className="text-sm text-primary mb-8">{t({ en: 'Active calls are still connected. Try again to reload the view.', ar: 'ÙŠØ±Ø¬Ù‰ Ø§Ù„Ù…Ø­Ø§ÙˆÙ„Ø© Ù…Ø±Ø© Ø£Ø®Ø±Ù‰ Ø£Ùˆ Ø§Ù„Ø¹ÙˆØ¯Ø© Ø¥Ù„Ù‰ Ø§Ù„ØµÙØ­Ø© Ø§Ù„Ø±Ø¦ÙŠØ³ÙŠØ©.' })}</p>
