...
<p className="text-[#141F33] mb-2">{t({ en: 'The voice dispatch dashboard had a hiccup.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
<p className="text-sm text-[#141F33] mb-8">{t({ en: 'Active calls are still connected. Try again to reload the view.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
