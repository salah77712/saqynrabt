...
<div className="h-3 w-24 bg-[#141F33] rounded animate-pulse mb-3" />
<div className="h-8 w-16 bg-[#141F33] rounded animate-pulse mb-2" />
...
<div className="h-5 w-32 bg-[#141F33] rounded animate-pulse mb-6" />
<div className="space-y-3">
{[...Array(4)].map((_, i) => (
<div key={i} className="flex items-center gap-8 p-3 rounded-[40px] bg-[#F8F9FB]">
...
<div className="h-6 w-16 bg-[#141F33] rounded-full animate-pulse" />
</div>
))}
</div>
</div>
