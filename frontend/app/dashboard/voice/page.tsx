...
if (!isVoiceActivated) {
return (
<main id="main-content" className="flex flex-col items-center justify-center min-h-[300px] text-center gap-6 animate-fadeIn" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
...
<div className="bg-[#F8F9FB] dark:bg-[#141F33] border border-[#141F33]/10 dark:border-[#141F33] p-6 rounded-2xl text-center gap-6 animate-fadeIn flex flex-col items-center">
