  ...
  return (
    <div className="flex items-center justify-center py-20">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold text-primary mb-2">{t({ en: 'Approvals didn\'t load', ar: 'صفحة الموافقات غير متوفرة' })}</h2>
        <p className="text-primary/60 mb-2">{t({ en: 'We couldn\'t fetch the pending approvals list.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
        <p className="text-sm text-primary/40 mb-8">{t({ en: 'Nothing\'s been lost. Try again to reload.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
