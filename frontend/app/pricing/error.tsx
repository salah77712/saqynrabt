    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-md">
          ...
          <p className="text-slate-500 mb-2">We couldn&apos;t load our pricing plans right now.</p>
          <p className="text-sm text-slate-400 mb-8">Please try again or contact us for pricing details.</p>
