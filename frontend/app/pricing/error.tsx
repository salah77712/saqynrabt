...
<p className="text-[#141F33] mb-2">{t({ en: "We couldn&apos;t load our pricing plans right now.", ar: 'تعذر تحميل خطط الأسعار حالياً.' })}</p>
<p className="text-sm text-[#141F33]/60 mb-8">{t({ en: 'Please try again or contact us for pricing details.', ar: 'يرجى المحاولة مرة أخرى أو الاتصال بنا للحصول على تفاصيل الأسعار.' })}</p>
...
<a href="/contact" className="inline-flex min-h-[44px] items-center justify-center rounded-full border border-[#141F33]/20 px-6 py-3 text-sm font-semibold text-[#141F33] hover:bg-[#F8F9FB] transition-all focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2">{t({ en: 'Contact us', ar: 'اتصل بنا' })}</a>
</div>
</div>
</main>
</div>
