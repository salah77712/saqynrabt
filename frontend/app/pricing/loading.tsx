...
<div className="mx-auto h-6 w-24 bg-[#141F33] rounded-full animate-pulse mb-6" />
<div className="mx-auto h-10 w-1/2 bg-[#141F33] rounded-lg animate-pulse mb-4" />
...
<div className="mt-5 h-11 w-full bg-[#141F33] rounded-lg animate-pulse" />
</div>
))}
</div>
</div>
