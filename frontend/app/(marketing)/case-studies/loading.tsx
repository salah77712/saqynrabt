            ...
            <div key={i} className="bg-surface border border-primary/10 rounded-xl p-8">
              <div className="flex flex-col lg:flex-row gap-8">
                <div className="flex-1 space-y-3">
                  ...
                  <div className="h-7 w-3/4 bg-surface rounded animate-pulse" />
                  <div className="h-4 w-full bg-surface rounded animate-pulse" />
                </div>
                <div className="lg:w-64 bg-surface rounded-xl p-5 space-y-3">
                  <div className="h-3 w-20 bg-surface rounded animate-pulse" />
                  {[...Array(3)].map((_, m) => (
                    <div key={m} className="h-4 w-36 bg-surface rounded animate-pulse" />
                  ))}
                </div>
              </div>
            </div>
