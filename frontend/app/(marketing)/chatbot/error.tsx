    ...
    <div className="bg-surface text-primary min-h-screen flex flex-col font-sans">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-md">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-surface border border-primary/10"><AlertTriangle className="w-6 h-6 text-primary" /></div>
          <h1 className="text-2xl font-bold text-primary mb-2">{t({ en: 'Chatbot page unavailable', ar: '???? ????? ??? ??? ??????' })}</h1>
          <p className="text-sm text-primary mb-2">{t({ en: 'We couldn\'t load the chatbot content right now.', ar: '???? ???????? ??? ???? ?? ?????? ??? ?????? ????????.' })}</p>
          <p className="text-xs text-primary mb-8">{t({ en: 'This is usually temporary. Please try again.', ar: '???? ???????? ??? ???? ?? ?????? ??? ?????? ????????.' })}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/" className="inline-flex min-h-[44px] items-center justify-center rounded-full border border-primary/10 px-6 py-3 text-sm font-semibold text-primary hover:bg-surface transition-all focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2">{t({ en: 'Back to Home', ar: '?????? ??? ????????' })}</a>
          </div>
        </div>
      </div>
    </div>
