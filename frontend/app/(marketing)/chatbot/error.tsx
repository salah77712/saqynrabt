    ...
    <div className="bg-surface text-primary min-h-screen flex flex-col font-sans">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-primary mb-2">{t({ en: 'Chatbot page unavailable', ar: 'صفحة الشات بوت غير متوفرة' })}</h1>
          <p className="text-sm text-primary mb-2">{t({ en: 'We couldn\'t load the chatbot content right now.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
          <p className="text-xs text-primary mb-8">{t({ en: 'This is usually temporary. Please try again.', ar: 'يرجى المحاولة مرة أخرى أو العودة إلى الصفحة الرئيسية.' })}</p>
