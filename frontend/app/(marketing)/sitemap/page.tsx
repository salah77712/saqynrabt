...
export default function VisualSitemapPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      links: [
        ...
        { href: '/chatbot', label: t('Internal Chatbot', 'المساعد الداخلي') },
    ...
    {
      title: t('RESOURCES & DEVELOPERS', 'الموارد والمطورين'),
      icon: (
        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-primary" viewBox="0 0 256 256">
      ...
      links: [
        ...
        { href: '/help/getting-started', label: t('Getting Started', 'دليل البداية') },
  ...
  return (
    <div className="bg-surface text-primary min-h-screen flex flex-col font-sans selection:bg-accent/10">
      <main className="flex-1 mx-auto max-w-7xl px-6 py-20 lg:px-8 w-full">
        ...
        <div className="mb-20">
          ...
          <p className="text-xs md:text-xs font-black uppercase tracking-widest text-primary/40 mt-4 leading-none">
            {t('SAQYN RABT SITEMAP � COMPLETE DIRECTORY OF PAGES & SERVICES', 'خريطة موقع ساقين ربط - دليل كامل للصفحات والخدمات')}
          </p>
        </div>

        {/* Heading Section */}

<h2 className="text-2xl md:text-3xl font-bold text-primary mb-8">Site Map</h2>
