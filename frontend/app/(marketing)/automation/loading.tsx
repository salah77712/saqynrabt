  ...
  return (
    <div className="bg-[#F8F9FB] text-[#141F33] min-h-screen flex flex-col font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-28 text-center">
        <div className="mx-auto mb-6 h-6 w-48 bg-[#141F33] rounded-full animate-pulse" />
        <div className="mx-auto h-12 w-3/4 bg-[#141F33] rounded-lg animate-pulse" />
        <div className="mx-auto mt-6 h-6 w-1/2 bg-[#F8F9FB] rounded animate-pulse" />
        <div className="mt-10 flex gap-8 justify-center">
          <div className="h-12 w-36 bg-[#141F33] rounded-lg animate-pulse" />
