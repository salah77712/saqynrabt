  ...
  return (
    <div className="bg-[#F8F9FB] text-[#141F33] min-h-screen flex flex-col font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-28 text-center">
        <div className="mx-auto mb-6 h-6 w-48 bg-[#141F33]/10 rounded-full animate-pulse" />
        <div className="mx-auto h-12 w-3/4 bg-[#141F33]/10 rounded-lg animate-pulse" />
        <div className="mx-auto mt-6 h-6 w-1/2 bg-[#F8F9FB] rounded animate-pulse" />
        <div className="mt-10 flex gap-4 justify-center">
          <div className="h-12 w-36 bg-[#141F33]/10 rounded-lg animate-pulse" />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="space-y-4">
              <div className="h-8 w-64 bg-[#141F33]/10 rounded animate-pulse" />
              {[...Array(6)].map((_, i) => (
                <div key={i} className="flex items-start gap-4 bg-[#F8F9FB] border border-[#141F33]/10 rounded-xl p-5">
                  <div className="h-8 w-8 bg-[#141F33]/10 rounded animate-pulse" />
                  <div className="flex-1 space-y-2">
                    <div className="h-4 w-40 bg-[#141F33]/10 rounded animate-pulse" />
            ...
            <div className="bg-[#F8F9FB] rounded-2xl border border-[#141F33]/10 p-6 space-y-4">
              <div className="h-6 w-24 bg-[#141F33]/10 rounded animate-pulse" />
              {[...Array(4)].map((_, i) => (
