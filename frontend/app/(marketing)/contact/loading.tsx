  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-6 py-20 lg:px-8 w-full">
        <div className="h-4 w-20 bg-primary rounded animate-pulse mb-6" />
        <div className="h-10 w-2/3 bg-primary rounded-lg animate-pulse mb-6" />
        <div className="h-5 w-full bg-surface rounded animate-pulse mb-10" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="border border-primary/10 rounded-xl p-8">
              <div className="h-6 w-32 bg-primary rounded animate-pulse mb-3" />
