    ...
    <div className="bg-surface text-primary min-h-screen flex flex-col font-sans">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-primary mb-2">{t({ en: 'FAQ unavailable', ar: '??????? ??????? ??? ??????' })}</h1>
          <p className="text-primary mb-8">{t({ en: "We couldn&apos;t load the FAQ. Please try again or contact us directly.", ar: '???? ????? ??????? ???????. ???? ???????? ??? ???? ?? ??????? ??? ??????.' })}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/contact" className="inline-flex min-h-[44px] items-center justify-center rounded-full border border-primary/10 px-6 py-3 text-sm font-semibold text-primary hover:bg-surface transition-all focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2">{t({ en: 'Contact us', ar: '???? ???' })}</a>
          </div>
        </div>
      </div>
    </div>
