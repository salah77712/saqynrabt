  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-6 py-20 lg:px-8 w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-primary mb-2">{t({ en: 'Terms & conditions unavailable', ar: 'قوانين وشروط غير متوفرة' })}</h1>
        <p className="text-primary/60 mb-2">{t({ en: "We couldn&apos;t load the terms and conditions.", ar: 'تعذر تحميل قوانين وشروط الاستخدام.' })}</p>
