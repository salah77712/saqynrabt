                ...
                return (
                  <div key={globalIdx} className="border border-[#141F33]/10 rounded-xl overflow-hidden">
                    <button
                      ...
                      className="w-full flex items-center justify-between px-6 py-3 text-left font-bold text-[#141F33] text-xs min-h-[44px] hover:bg-[#F8F9FB] transition-all duration-300"
                    >
                      <span>{item.q}</span>
