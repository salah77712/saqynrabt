      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="w-full min-h-[260px] md:min-h-[340px] rounded-xl bg-[#141F33] text-[#F8F9FB] p-8 md:p-12 relative overflow-hidden flex flex-col justify-between shadow-xl">
              ...
              <div className="flex items-start justify-between relative z-10">
                ...
                <div className="w-14 h-14 rounded-xl bg-[#2A5CFF]/20 text-[#2A5CFF] flex items-center justify-center shadow-lg border border-[#2A5CFF]/30">
          ...
          <div className="space-y-8 lg:sticky lg:top-24">
            <div className="bg-white border border-[#141F33]/10 rounded-xl p-8 shadow-sm shadow-card">
              ...
              <div className="space-y-4">
                {details.metrics.map((metric, i) => (
                  <div key={i} className="flex items-start gap-4 bg-[#F8F9FB] border border-[#141F33]/10 rounded-xl p-4 shadow-sm">
            ...
            {/* CTA Box */}
            <div className="bg-[#141F33] rounded-xl p-8 text-center text-[#F8F9FB] shadow-xl relative overflow-hidden">
