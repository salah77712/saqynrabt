  ...
  if (pendingVerification) {
    return (
      <div className="flex min-h-screen bg-[#F8F9FB] items-center justify-center px-4" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
        <div className="bg-[#F8F9FB] rounded-xl shadow-xl p-8 border border-[#141F33]/10 w-full max-w-md animate-fadeIn text-center">
...
{error && (
    <div className="bg-[#141F33] border border-[#141F33]/10 text-[#141F33] rounded-xl p-3.5 text-xs font-bold mb-6 text-center">
{error}
</div>
)}
          ...
          <form onSubmit={handleVerification} className="space-y-4">
            <input
              ...
              className="w-full min-h-[44px] bg-[#F8F9FB] border border-[#141F33]/10 rounded-xl px-4 py-3 text-center text-sm font-bold tracking-widest text-[#141F33] focus:outline-none focus:ring-2 focus:ring-accent focus:ring-royal"
              required
            />
            <button
              type="submit"
...
{error}
        ...
        {emailParam ? (
          <div className="mb-6 p-4 rounded-xl bg-[#F8F9FB] border border-[#2A5CFF]/10/80 text-[#2A5CFF] flex items-start gap-4.5 shadow-sm">
          ...
          <div className="mb-6 p-4 rounded-xl bg-[#F8F9FB] border border-[#2A5CFF]/10/80 text-[#141F33] flex items-start gap-4.5 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              disabled={!!emailParam}
              className="w-full min-h-[44px] bg-[#F8F9FB] border border-[#141F33]/10 rounded-xl px-4 py-2 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-accent focus:ring-royal disabled:opacity-70 disabled:cursor-not-allowed"
              required
            />
          </div>
