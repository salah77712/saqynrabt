          ...
          <form onSubmit={handle2FASubmit} className="space-y-4">
            ...
            <div>
              <input
                ...
                className="w-full min-h-[44px] bg-[#F8F9FB] border border-[#141F33]/10 rounded-[40px] px-4 py-2 text-center text-lg font-bold tracking-widest focus:outline-none focus:ring-2 focus:ring-2 focus:ring-royal"
                required
              />
            </div>
...
<button
        ...
        className="w-full py-3 px-6 rounded-[40px] text-xs font-bold min-h-[44px] text-[#141F33] bg-[#F8F9FB] border border-[#141F33]/10 hover:bg-[#141F33] transition-all"
      >
...
className="w-full bg-[#141F33] text-[#F8F9FB] font-bold py-3 rounded-[40px] text-xs hover:opacity-95 transition-all min-h-[44px] flex items-center justify-center disabled:opacity-40"
            ...
            <div className="grid grid-cols-2 gap-8">
              <button
                ...
                className="flex items-center justify-center border border-[#141F33]/10 rounded-[40px] py-3 px-6 text-xs font-bold text-[#141F33] hover:bg-[#141F33] transition-colors min-h-[44px]"
              >
                Google
              </button>
              <button
