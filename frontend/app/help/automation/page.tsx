        ...
        <div className="flex-1 bg-[#F8F9FB] border border-[#141F33]/10 rounded-2xl p-6 shadow-sm space-y-6">
          <div>
            ...
            <h1 className="text-3xl font-extrabold text-[#141F33] tracking-tight mt-2">
              {t({ en: 'Business Call Automation', fr: 'Automatisation des appels d\'entreprise', ar: 'أتمتة المكالمات الهاتفية', hi: 'बिजनेस कॉल ऑटोमेशन' })}
            </h1>
            <p className="text-xs font-semibold text-[#141F33] mt-2">
              {t({ en: 'Configure incoming voice dispatches, queue routers, and scheduling integrations.', fr: 'Configurez les répartitions vocales entrantes, les routeurs de file d\'attente et les intégrations de planification.', ar: 'تهيئة وتكوين توزيع المكالمات الصوتية الواردة، وموجهات الطابور.', hi: 'आने वाले वॉयस डिस्पैच, कतार राउटर और शेड्यूलिंग इंटीग्रेशन को कॉन्फ़िगर करें।' })}
            </p>
          </div>
