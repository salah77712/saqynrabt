        ...
        <div className="flex-1 bg-surface border border-primary/10 rounded-xl p-8 shadow-sm space-y-6">
          <div>
            ...
            <p className="text-xs font-semibold text-primary mt-2">
              {t({ en: 'Configure au limits, verify monthly metrics, and review billing prorations.', ar: 'تهيئة حدود التجاوز التلقائي، التحقق من المقاييس الشهرية، ومراجعة الحسابات.' })}
            </p>
          </div>
